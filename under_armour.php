...
function searchFilter(page_num) {
    ...
    //get number of rows
    $queryNum = $db->query("SELECT COUNT(*) as postNum FROM underarmour");
    ...
    //get rows
    $query = $db->query("SELECT * FROM underarmour ORDER BY id DESC LIMIT $limit");
   $output ="";
$i = 0;
 if($query->num_rows > 0){
