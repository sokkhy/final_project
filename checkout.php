...
<!-- Mirrored from demo.themeum.com/html/eshopper/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2017 07:48:39 GMT -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <title>Checkout | 4Shop</title>
		...
		<div class="container">
			...
			<div class="checkout-options">
				...
				<ul class="nav">
					...
					<li>
						<a href="javascript:"><i class="fa fa-times"></i>Cancel</a>
					</li>
				</ul>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<a class="btn btn-primary" href="javascript:">Get Quotes</a>
							<a class="btn btn-primary" href="javascript:">Continue</a>
						</div>
					</div>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href="javascript:"><img src="images/cart/one.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="javascript:">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
							</td>
							<td class="cart_price">
								<p>$59</p>
							...
							<td class="cart_delete">
								<a class="cart_quantity_delete" href="javascript:"><i class="fa fa-times"></i></a>
							</td>
						</tr>

						<tr>
							<td class="cart_product">
								<a href="javascript:"><img src="images/cart/two.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="javascript:">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href="javascript:"><img src="images/cart/three.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="javascript:">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
