...
<!-- Mirrored from demo.themeum.com/html/eshopper/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2017 07:48:55 GMT -->
<head>
    <meta charset="utf-8">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="javascript:"><i class="fa fa-phone"></i> +2 95 01 88 821</a></li>
								<li><a href="javascript:"><i class="fa fa-envelope"></i> info@domain.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						...
						<div class="btn-group pull-right clearfix">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="javascript:">Canadian Dollar</a></li>
									<li><a href="javascript:">Pound</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								<li><a href="javascript:"><i class="fa fa-user"></i> Account</a></li>
								<li><a href="javascript:"><i class="fa fa-star"></i> Wishlist</a></li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="javascript:" class="active">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
			...
			<div class="row">
				...
				<div class="col-sm-9">
					...
					<div class="rating-area">
						...
						<ul class="tag">
							<li>TAG:</li>
							<li><a class="color" href="javascript:">Pink <span>/</span></a></li>
							<li><a class="color" href="javascript:">T-Shirt <span>/</span></a></li>
							<li><a class="color" href="javascript:">Girls</a></li>
						</ul>
					</div><!--/rating-area-->

					<div class="socials-share">
						<a href="javascript:"><img src="images/blog/socials.png" alt=""></a>
					</div><!--/socials-share-->
					...
					<div class="media commnets">
						...
						<div class="media-body">
							...
							<div class="blog-socials">
								...
								<a class="btn btn-primary" href="javascript:">Other Posts</a>
							</div>
						</div>
					</div><!--Comments-->
						...
						<ul class="media-list">
							<li class="media">
								...
								<div class="media-body">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<a class="btn btn-primary" href="javascript:"><i class="fa fa-reply"></i>Replay</a>
								</div>
							</li>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<div class="text-area">
									...
									<a class="btn btn-primary" href="javascript:">post comment</a>
								</div>
							</div>
						</div>
					</div><!--/Repaly Box-->
