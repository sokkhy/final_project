...
<!-- Mirrored from demo.themeum.com/html/eshopper/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Dec 2017 07:48:40 GMT -->
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="chose_area">
						...
						<a class="btn btn-default update" href="javascript:">Get Quotes</a>
						<a class="btn btn-default check_out" href="javascript:">Continue</a>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<a class="btn btn-default update" href="javascript:">Update</a>
							<a class="btn btn-default check_out" href="javascript:">Check Out</a>
					</div>
				</div>
			</div>
		</div>
	</section><!--/javascript:do_action-->
